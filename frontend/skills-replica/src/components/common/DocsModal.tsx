  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-3xl bg-white rounded-2xl shadow-window overflow-hidden animate-in fade-in zoom-in duration-200 flex flex-col max-h-[85vh]">
        ...
        {/* Content */}
        <div className="p-8 overflow-y-auto prose prose-pink max-w-none">
          ...
          <p>
            ...
            Think of them as "skills" or "tools" that give Claude new capabilities, like searching the web, 
            reading files, or accessing databases.
          </p>
          ...
          <div className="bg-gray-50 p-4 rounded-xl border border-gray-200 not-prose my-6">
            <ol className="list-decimal list-inside space-y-2 font-mono text-sm text-gray-700">
              ...
              <li>Click <strong>Checkout</strong> to copy the merged configuration.</li>
              <li>Paste it into your <code>claude_desktop_config.json</code> file.</li>
            </ol>
          </div>
          ...
          <ul className="font-mono text-xs bg-gray-900 text-gray-300 p-4 rounded-lg list-none">
            <li className="mb-2"><span className="text-pink-400">macOS:</span> ~/Library/Application\ Support/Claude/claude_desktop_config.json</li>
            <li><span className="text-blue-400">Windows:</span> %APPDATA%\Claude\claude_desktop_config.json</li>
          </ul>

          <div className="mt-8 pt-8 border-t border-gray-100 text-center">
            <button 
              onClick={onClose}
              className="px-8 py-3 bg-primary text-white rounded-full font-bold shadow-lg hover:bg-pink-600 transition-colors"
            >
              Got it, let's shop!
            </button>
          </div>
